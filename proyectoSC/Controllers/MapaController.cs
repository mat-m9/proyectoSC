...
namespace proyectoSC.Controllers
{
    ...
    public class MapaController : ControllerBase
    {
        ...
        {
            context.Mapas.Add(new MapaModel { Name = request.name, Content = request.content });
            try
            {
        ...
        {
            var document = await context.Mapas.Where(d => d.Id == id).FirstOrDefaultAsync();
        ...
        {
            var documents = await context.Mapas
